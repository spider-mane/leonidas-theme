...
/******/ 	return __webpack_require__(__webpack_require__.s = "./theme/assets/src/js/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"config\", function() { return config; });\n\r\nconst config = {\r\n\r\n  navbar: {\r\n\r\n  },\r\n\r\n  reCapcha: {\r\n    key: ''\r\n  },\r\n\r\n  google: {\r\n    maps: {\r\n      key: ''\r\n    },\r\n  },\r\n}\r\n\n\n//# sourceURL=webpack:///./theme/assets/src/js/config.js?");

/***/ }),

/***/ "./theme/assets/src/js/index.js":
/*!**************************************!*\
  !*** ./theme/assets/src/js/index.js ***!
  \**************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/stable */ \"./node_modules/core-js/stable/index.js\");\n/* harmony import */ var core_js_stable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_stable__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! regenerator-runtime/runtime */ \"./node_modules/regenerator-runtime/runtime.js\");\n/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./state */ \"./theme/assets/src/js/state.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./config */ \"./theme/assets/src/js/config.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/base */ \"./theme/assets/src/js/views/base.js\");\n/* harmony import */ var _views_navbar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/navbar */ \"./theme/assets/src/js/views/navbar.js\");\n/* harmony import */ var _views_header__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/header */ \"./theme/assets/src/js/views/header.js\");\n\n\n\n\n\n\n\n\n\n/**\n *\n */\nwindow.state = _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"];\n// Aos.init();\n\n/**\n *\n */\nif ('grecaptcha' in window) {\n  grecaptcha.ready(() => {\n    grecaptcha.execute(_config__WEBPACK_IMPORTED_MODULE_3__[\"config\"].reCapcha.key, { action: 'contact' }).then((token) => {\n      _views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].forms.reCaptcha.value = token;\n    });\n  });\n}\n\n/**\n *\n */\ndocument.addEventListener('scroll', (e) => {\n  if (!_state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.open) {\n    transformNavbar(e);\n  }\n})\n\n/**\n *\n */\n_views_base__WEBPACK_IMPORTED_MODULE_4__[\"elements\"].navbar.toggler.addEventListener('click', (e) => {\n\n  const colorChanged = _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.changed;\n  const passedThreshold = _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.threshold;\n\n  if (false === _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.open) {\n\n    if (!passedThreshold && !colorChanged) {\n      toggleNavbarColor(true)\n      _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"fixPosition\"]()\n    }\n\n    Object(_views_base__WEBPACK_IMPORTED_MODULE_4__[\"toggleScroll\"])('hidden');\n    _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"showNavItems\"]().toggleToggler('close');\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.open = true;\n\n  } else {\n\n    if (!passedThreshold && colorChanged) {\n      toggleNavbarColor(false);\n      _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"releasePosition\"]()\n    }\n\n    Object(_views_base__WEBPACK_IMPORTED_MODULE_4__[\"toggleScroll\"])('scroll');\n    _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"hideNavItems\"]().toggleToggler('open');\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.open = false;\n  }\n})\n\n/**\n *\n */\nfunction toggleNavbarColor(toggle) {\n  _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"toggleColor\"]()\n  _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.changed = toggle\n}\n\n/**\n *\n */\nfunction transformNavbar(e) {\n\n  const scrollStart = window.scrollY;\n  const startChange = _views_header__WEBPACK_IMPORTED_MODULE_6__[\"bottom\"] - _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"height\"] / 2;\n\n  //\n  if (scrollStart > startChange) {\n    _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"fixPosition\"]()\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.fixed.set = true;\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.fixed.threshold = true;\n\n    if (!_state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.changed) {\n      toggleNavbarColor(true)\n      _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.threshold = true\n    }\n  }\n\n  //\n  if (scrollStart < startChange) {\n    _views_navbar__WEBPACK_IMPORTED_MODULE_5__[\"releasePosition\"]()\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.fixed.set = true;\n    _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.fixed.threshold = true;\n\n    if (_state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.changed) {\n      toggleNavbarColor(false)\n      _state__WEBPACK_IMPORTED_MODULE_2__[\"state\"].navbar.color.threshold = false\n    }\n  }\n\n  return this;\n}\n\n\n//# sourceURL=webpack:///./theme/assets/src/js/index.js?");

/***/ }),

/***/ "./theme/assets/src/js/state.js":
/*!**************************************!*\
  !*** ./theme/assets/src/js/state.js ***!
  \**************************************/
